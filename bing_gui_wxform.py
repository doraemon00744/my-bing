...
class BingWx(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"bing壁纸宝", pos=wx.DefaultPosition, size=wx.Size(640, 580),
        ...
        self.img_bitmap = wx.StaticBitmap(self, wx.ID_ANY, wx.NullBitmap,
                                          wx.DefaultPosition, wx.Size(640, 360), 0)
        bSizer3.Add(self.img_bitmap, 0, 0, 5)

        self.description_staticText = wx.StaticText(self, wx.ID_ANY, u"^.^", wx.DefaultPosition, wx.Size(610, 30),
                                                    wx.ALIGN_CENTRE | wx.ST_ELLIPSIZE_END)
        self.description_staticText.Wrap(2)
        self.description_staticText.SetFont(
        ...
        self.left_bpButton = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap,
                                             wx.DefaultPosition, wx.Size(40, 40), wx.BU_AUTODRAW)
        bSizer5.Add(self.left_bpButton, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        bSizer5.Add((0, 0), 1, wx.EXPAND, 5)

        self.right_bpButton = wx.BitmapButton(self, wx.ID_ANY, wx.NullBitmap,
                                              wx.DefaultPosition, wx.Size(40, 40), wx.BU_AUTODRAW)
